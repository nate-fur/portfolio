...
export const GameCell = React.memo<GameCellProps>(({
	...
	const getCellClasses = () => {
		const baseClasses = "border border-gray-400 flex items-center justify-center font-semibold cursor-pointer select-none transition-all duration-150";
	...
	const getNumberColor = () => {
		if (cell.isRevealed && !cell.isMine && cell.neighborMines > 0) {
			return NUMBER_COLORS[cell.neighborMines as keyof typeof NUMBER_COLORS] || "text-gray-600";
		}
		return "";
	};
