import type { XPost, XApiError } from '../types';
import { X_API_CONFIG, MOCK_POSTS, ERROR_MESSAGES } from './constants';
...
export class XApiClient {
  ...
  async fetchUserPosts(userId?: string): Promise<XPost[]> {
    ...
    if (cached && Date.now() - cached.timestamp < X_API_CONFIG.RATE_LIMIT.CACHE_DURATION) {
      return cached.data;
    }
